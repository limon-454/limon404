...
\033[1;97m
 ...
 | )   ( || )   ( || )      ___) (___| )   ( |
 |/     \||/     \||/       \_______/|/     \|
\033[1;95m|| Created By LIMON-TOOLS
\033[1;94m|| Github.com/limon-404
...
def moch_yayan():
    ...
    if pepek == '':
        ...
        try:
            ...
            print '\n [ hasil crack yang tersimpan di file anda ]\'n'
            for file in dirs:
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : LIMON-TOOLS '%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : LIMON-TOOLS .'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/LIMON-TOOLS '%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/PRINC-LIMON-100085231615680/'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : https://www.facebook.com/PRINC-LIMON-100085231615680/'%(N,H,N);time.sleep(0.07)
